var timerId = null; //Variavel que armazena a função timeout
...
function iniciaJogo(){
	...
	if (nivel_jogo == 1) {	//1 Facil -> 120seg
		tempo_segundos = 120;
	}

	if (nivel_jogo == 2) {	//2 Normal -> 60seg
		tempo_segundos = 60;
	}

	if (nivel_jogo == 3) {	//3 Dificil -> 30seg
		tempo_segundos = 30;
	}
...
function remove_eventos_baloes() {
     ...
     document.getElementById('b'+i).onclick = '';i++;
  }
}
